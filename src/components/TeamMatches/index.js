...
class TeamMatches extends Component {
  ...
  getTeamMatches = async () => {
    ...
    const updatedData = {
      ...
      latestMatchDetails: {
        ...
        id,
        competingTeam: fetchedData.latest_match_details,
        competing_team,
        competingTeamLogo: fetchedData.latest_match_details,
        competing_team_logo,
        date: fetchedData.latest_match_details.date,
        firstInnings: fetchedData.latest_match_details.firstInnings,
  ...
  renderRecentMatchesList = () => {
    ...
    return (
      <ul className="recent_matches_list">
  ...
  render() {
    ...
    const {id} = params
    return (
      <div className={`map-team-matches-container ${id}`}>
